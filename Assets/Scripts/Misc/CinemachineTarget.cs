...
public class CinemachineTarget : MonoBehaviour
{
    ...
    void SetCinemachineTargetGroup()
    {
        ...
        CinemachineTargetGroup.Target cinemachineGroupTarget_cursor = new CinemachineTargetGroup.Target { weight = 1f, radius = 1f, target = GameManager.Instance.Player.transform };
